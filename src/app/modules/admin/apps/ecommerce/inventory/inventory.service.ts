...
export class InventoryService
{
    ...
    {
        console.log("inventoryService - getProducts "+search)
    ...
    getProductById(id: string): Observable<InventoryProduct>
    {
        ...
        this._httpClient.get<{ pagination: InventoryPagination; products: InventoryProduct[] }>('api/apps/ecommerce/inventory/products', {
            params: {
                page: "0",
                size: "10",
                sort : "name",
                order : "asc",
                search : "id=3f34e2fb-95bf-4f61-be28-956d2c7e4eb2"
            }
        }).pipe(
            tap((response) => {
                this._pagination.next(response.pagination);
        ...
        console.log("inventoryService - getProductById "+id)
        this._products.forEach((p) => console.log("inventoryService - getProductById - "+JSON.stringify(p)) )
