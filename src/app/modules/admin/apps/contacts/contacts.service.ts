...
export class ContactsService {
    ...
    loadContact(c: Contact) {
        console.log(this.contactUrl+' ' + c.name)

        this._httpClient.post<Contact>(this.contactUrl, { name: c.name }).pipe(
            tap(t => console.log("yo "+t.id))
        );
    ...
    getTags(): Observable<Tag[]> {
        return this._httpClient.get<Tag[]>(environment.backend + '/usertypes').pipe(
            tap((tags) => {
